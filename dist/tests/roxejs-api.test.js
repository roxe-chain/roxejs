...
var roxejs_jssig_1 = require("../roxejs-jssig");
var transaction = {
...
describe('roxejs-api', function () {
    ...
    it('getAbi returns an abi', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api.getAbi('testroxetoken')];
                case 1:
                    response = _a.sent();
    ...
    it('getContract returns a contract', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api.getContract('testroxetoken')];
                case 1:
                    response = _a.sent();
...
//# sourceMappingURL=roxejs-api.test.js.map