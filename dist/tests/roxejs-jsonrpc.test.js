    ...
    it('throws error bad status', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    e_1 = _a.sent();
                    expect(e_1).toBeInstanceOf(roxejs_rpcerror_1.RpcError);
    ...
    it('throws error unprocessed', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    e_2 = _a.sent();
                    expect(e_2).toBeInstanceOf(roxejs_rpcerror_1.RpcError);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    jsonRpc = new roxejs_jsonrpc_1.JsonRpc(endpoint, { fetch: myFetch });
                    return [4 /*yield*/, jsonRpc.get_abi(accountName)];
                case 1:
                    _a.sent();
...
//# sourceMappingURL=roxejs-jsonrpc.test.js.map