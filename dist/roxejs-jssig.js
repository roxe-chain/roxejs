 ...
 * @module JS-Sig
 */
// copyright defined in roxejs/LICENSE.txt
...
var ecc = require("roxejs-ecc");
var roxejs_numeric_1 = require("./roxejs-numeric");
    ...
    function JsSignatureProvider(privateKeys) {
        ...
        try {
            for (var privateKeys_1 = __values(privateKeys), privateKeys_1_1 = privateKeys_1.next(); !privateKeys_1_1.done; privateKeys_1_1 = privateKeys_1.next()) {
                ...
                var pub = roxejs_numeric_1.convertLegacyPublicKey(ecc.PrivateKey.fromString(k).toPublic().toString());
                this.keys.set(pub, k);
    ...
    JsSignatureProvider.prototype.sign = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                signatures = requiredKeys.map(function (pub) { return ecc.Signature.sign(signBuf, _this.keys.get(roxejs_numeric_1.convertLegacyPublicKey(pub))).toString(); });
...
//# sourceMappingURL=roxejs-jssig.js.map